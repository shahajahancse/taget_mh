...
document.image.src = "http://"+hostname+"/erp/uploads/photo/"+img;
...
function com_info_Search1()
{
 ...
 var queryString="empid="+empid;
 //alert(queryString);
 ajaxRequest.open("POST", "com_info_search1/", true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		for (i=0; i<=1; i++){
			...
			if( com_info[15] == attbonus_name[i])
			{
...
//myRef.moveTo(0,0);
	...
	ajaxRequest.open("POST", "daily_absent/", true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
	ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
...
//myRef.moveTo(0,0);
	...
	ajaxRequest.open("POST", "process/", true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
	ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
...
//alert(empid_leave);
 ...
 ajaxRequest.open("POST", "save_leave_co/", true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
var queryString="emp_id="+emp_id+"&loan_amt="+loan_amt+"&pay_amt="+pay_amt+"&loan_date="+loan_date;
 ...
 ajaxRequest.open("POST", "advance_loan_insert/", true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
function find_style_winding()
{
 ...
 //alert(queryString);
 url =  "http://"+hostname+"/erp/index.php/product_con/find_style_name_winding/";
...
ajaxRequest.onreadystatechange = function(){
	if(ajaxRequest.readyState == 4){
		...
		document.getElementById('style_type').value = alldata[1];	
...
function find_style()
{
 ...
 try{
  ...
  var queryString="article_name="+article_name;
 //alert(queryString);
 url =  "http://"+hostname+"/erp/index.php/product_con/find_style_name/";
 ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
...
//	alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_winding_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_mending()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_mending_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_zipper()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_zipper_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_function()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_knitting_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_winding()
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/show_table_winding/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_mending()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/show_table_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_zipper()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/show_table_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/show_table_co/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_mending(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_edit_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit_zipper(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_edit_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_edit(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_edit/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_mending(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_delete_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete_zipper(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_delete_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_delete(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_delete/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_mending(i)
{
 ...
 try{
   ...
   try{
	...
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_update_mending/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update_zipper(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_update_zipper/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_update(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_update/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_save_linking()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name+"&style_type_id="+style_type_id+"&style_price="+style_price;
//	alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/price_code_linking_save/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_edit(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_linking_edit/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_update(i)
{
 ...
 try{
   ...
   try{
	...
	var queryString="i="+i+"&get_style_price="+get_style_price;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_linking_update/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function price_code_linking_delete(i)
{
 ...
 var queryString="i="+i;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/style_type_perice_linking_delete/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
function show_table_linking()
{
 ...
 try{
   ...
   try{
	...
	var queryString="article_name="+article_name+"&style_name="+style_name;
	//alert(queryString);
    url="http://"+hostname+"/erp/index.php/product_con/show_table_linking_co/" ;
	ajaxRequest.open("POST" ,url , true);
	ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	ajaxRequest.send(queryString);
...
var ajaxRequest;  // The variable that makes Ajax possible!
 ...
 //alert(queryString);
 hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp/index.php/product_con/bdt_save_co/";
	ajaxRequest.open("POST", url, true);
 ajaxRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
 ajaxRequest.send(queryString);
