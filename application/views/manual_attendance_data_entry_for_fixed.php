...
<div style="width:670px;">
	...
	<select id='year' name="year">
       ...
       <div id="grid_production_logs">
        ...
        <div style="height:24px;">
	   <div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="23"></div>
	 

	   <div class="div_row_normal"><input id="friday" type="text" name="friday" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="24"></div>
	   
	    <div class="div_row_normal"><input id="h_day" type="text" name="h_day" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="25"></div>
	    
	    
	    <div class="div_row_normal"><input id="leave" type="text" name="leave" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="26"></div>
	   
	   <div class="div_row_normal"><input id="night" type="text" name="night" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="27"></div>
         
        
         
         
         
      <div class="div_row_normal"><input id="extra_fri" type="text" name="extra_fri" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="28"></div>
      
      <div class="div_row_normal"><input id="no_work" type="text" name="no_work" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" value="0" tabindex="29"></div>
...
$(function(){
	...
	$('#add_production_log_button').click(function(){ 
		...
		var extra_fri 			= document.getElementById('extra_fri').value;
		...
		if(emp_id==0 || emp_id=='')
		   ...
		   if(extra_fri=='')
		  {
			...
			tabindex = 28;
			document.getElementById('extra_fri').focus();
		  	return;
		  }
		  ...
		  $.ajax({
				...
				success: function(data){
					...
					{
						$('#grids').html('<div style="width:940px; overflow:auto;" id="grids"><div style="height:24px;"><div class="div_row_normal"><input id="p_day" type="text" name="p_day" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="23"></div><div class="div_row_normal"><input id="friday" type="text" name="friday" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="24"></div><div class="div_row_normal"><input id="h_day" type="text" name="h_day"style="width:110px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="25"></div><div class="div_row_normal"><input id="leave" type="text" name="leave"style="width:110px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="26"></div><div class="div_row_normal"><input id="night" type="text" name="night" style="width:110px; background-color:transparent;  border:1px #330000 thin; border-style:groove;" tabindex="27"></div><div class="div_row_normal"><input id="extra_fri" type="text" name="extra_fri"style="width:110px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="28"></div><div class="div_row_normal"><input id="no_work" type="text" name="no_work"style="width:110px; background-color:transparent;border:1px #330000 thin; border-style:groove;" tabindex="29"></div></div><div style="clear:both;"></div></div>');
					}
...
function GetImageOthers(){
	...
	ajaxRequest.onreadystatechange = function(){
		if(ajaxRequest.readyState == 4){
			...
			document.getElementById('friday').value 	= data[7];
			document.getElementById('h_day').value 		= data[8];
			document.getElementById('leave').value 		= data[9];
			document.getElementById('night').value 		= data[10];
			document.getElementById('extra_fri').value 	= data[11];
