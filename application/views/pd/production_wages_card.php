...
<div style="width:1060px;margin-bottom:8px; min-height:360px; border:1px  dashed; padding-top:4px;">
  ...
  <div style="width:48%; float:left; border:2px solid; padding-right:3px ">
    ...
    <div> 
	  ...
	  ?>
      <tr>
      <td><?php echo $values[$emp_id]["article_id"][$j];?></td>
      <td><?php echo $values[$emp_id]["process_id"][$j];?></td>
      <td><?php echo $values[$emp_id]["size_id"][$j];?></td>
      <td><?php echo $values[$emp_id]["total_quantity"][$j];?></td>
      <?php $total_pcs = $total_pcs + $values[$emp_id]["total_quantity"][$j]; ?>
      <td style="text-align:right"><?php echo $values[$emp_id]["unit_price"][$j];?></td>
      <td style="text-align:right"><?php echo $values[$emp_id]["amount"][$j];?></td></tr>
