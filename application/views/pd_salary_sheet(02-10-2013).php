...
<?php
	...
	for($p=0; $p<=$per_page_row;$p++)
	{
		...
		$BODY = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$body_id,$floor);
		$NECK = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$neck_id,$floor);
		
		$COMPLET = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$complet_id,$floor);
		$REMENDING = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$remending_id,$floor);
		
		$LBS = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$lbs_id,$floor);
		$Moon = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$moon_id,$floor);
		$PLACKET = $this->pd_salary_report_model->get_pd_info($emp_id,$sec_id,$sal_month,$sal_year,$placket_id,$floor);
