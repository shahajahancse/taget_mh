	...
	<fieldset style='width:90%;'><legend><font size='+1'><b>Weekend</b></font></legend>
		<form name='manual_attendance'>
			<table>
				<tr>
					<td>
						<input type='button' name='btn' id='btn' onclick='save_work_off()' value='Insert' size='15'>
						<input type='button' name='btn' id='btn' onclick='save_work_off()' value='Delete' size='15'>
					</td>
				</tr>
				<tr>
					<td>
	...
	<fieldset style='width:90%;'><legend><font size='+1'><b>Holiday</b></font></legend>
		<form name='manual_attendance'>
			...
			<tr>
				<td>Description</td>
				<td>
					<input type='text' size='16px' id='holiday_description'><input type='button' name='holiday_save_id'  onclick='save_holiday()' value='Insert'/>
				</td>
			</tr>
			<tr>
				<td></td>
