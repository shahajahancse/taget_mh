...
function grid_daily_present_report()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/grid_con/grid_daily_report/"+firstdate+"/"+status+"/"+spl;
...
function grid_daily_late_report()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/grid_con/grid_daily_late_report/"+firstdate+"/"+spl;
