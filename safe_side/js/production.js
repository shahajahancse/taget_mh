function production_salary_sheet()
{
 ...
 try{
   ...
   url =  "http://"+hostname+"/erp_target_net/index.php/production_salary_report_con/production_monthly_salary_sheet/";
...
/*var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/production_salary_report_con/production_monthly_salary_sheet/"+sal_year_month+"/"+grid_status+"/"+spl;
...
year= document.getElementById('report_year_sal').value;
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_process_con/pd_process/";
...
function production_monthly_salary_summary()
{
	...
	var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_salary_summary/"+sal_year_month+"/"+grid_status;
...
function grid_production_block_wise()
{
	...
	var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_block_wise_salary_summary/"+sal_year_month+"/"+grid_status+"/"+grid_section+"/"+grid_floor;
...
function grid_production_floor_wise()
{
	...
	var sal_year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_floor_wise_salary_summary/"+sal_year_month+"/"+grid_status+"/"+grid_section;
...
ajaxRequest.onreadystatechange = function(){
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/grid_con/grid_get_all_data_production";
...
{var dept 			= document.getElementById('grid_dept').value;	
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/grid_con/grid_all_search_production/"+dept+"/"+section+"/"+line+"/"+designation+"/"+sex+"/"+status+"/"+position;
...
function grid_daily_production_report()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_daily_report/"+firstdate;
...
function grid_daily_production_summary()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/daily_production_summary/"+firstdate+"/"+grid_section;
...
function production_job_card()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_job_card/"+firstdate+"/"+seconddate+"/"+spl;
...
function production_summary()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_summary/";
...
function production_monthly_cost_sheet()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_cost_sheet/"+firstdate;
...
var year_month = report_year_sal+"-"+report_month_sal+"-"+"01";
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/grid_production_wages_card"+"/"+year_month+"/"+spl;
...
function production_monthly_attn_register()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_attn_register/"+firstdate+"/"+spl;
...
function grid_continious_section_production_summary()
{
	...
	//alert(grid_process);
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/continious_section_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_process+"/"+grid_status;
...
function grid_continious_floor_production_summary()
{
	...
	var grid_process = document.getElementById('grid_pd_process').value;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/continious_floor_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_position+"/"+grid_process+"/"+grid_status;
...
function grid_continious_block_production_summary()
{
	...
	var grid_process = document.getElementById('grid_pd_process').value;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/continious_block_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_position+"/"+grid_line+"/"+grid_process+"/"+grid_status;
...
function grid_monthly_floor_production_summary()
{
	...
	var grid_status = document.getElementById('grid_status').value;
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/monthly_floor_production_summary/"+firstdate+"/"+seconddate+"/"+grid_section+"/"+grid_position+"/"+grid_status;
...
function production_monthly_style()
{
	...
	hostname = window.location.hostname;
	url =  "http://"+hostname+"/erp_target_net/index.php/pd_report_con/production_monthly_style/"+firstdate+"/"+grid_section+"/"+grid_position+"/"+grid_line+"/"+spl+"/"+grid_pd_process;
