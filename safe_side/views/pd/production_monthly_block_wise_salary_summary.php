...
?>
<span style="font-size:13px; font-weight:bold;"><?php echo "Section : $sec_name&nbsp;&nbsp;&nbsp;Floor : $floor_name"; ?> <?php 
	if($grid_status == 1)
	{ echo 'Reguler'; }
	...
	{ echo 'Promoted'; }
	?>  Blockwise Salary Summary For The Month of <?php echo $month_year; ?></span>
<br />
<br />
...
<?php
if($sec_name == "Knitting" || $sec_name == "Triming" || $sec_name == "Mending")
{
